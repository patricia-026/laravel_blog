...
@else
    <p>
        <a href="/register" class="hover:underline font-semibold text-blue-500">Register</a> or <a href="/login"
            class="hover:underline font-semibold text-blue-500">log in</a> to leave a comment.
    </p>
@endauth
